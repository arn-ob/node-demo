...
exports.finalize_Doctor = function (req, res) {
    ...
    var sql2 = "INSERT INTO doctor(reg_id, registration_no, date_of_birth,  created_date, created_time) VALUES ('" + input.reg_id + "','" + input.reg + "','" + BOD + "','" + present_date + "','" + present_time + "')";
